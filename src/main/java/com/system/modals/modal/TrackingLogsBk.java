...
public class TrackingLogsBk implements java.io.Serializable {
	...
	public TrackingLogsBk() {
	}

	public TrackingLogsBk(String orderCode, String orderReferenceCode, Date changeDate,
